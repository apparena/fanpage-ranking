...
<head>
    ...
    <title>Fanpage Ranking App</title>
    <link rel="icon" type="image/png" href="img/fanranking_favicon.png" />
    ...
    <?php if (__c('css_user', 'src') !== false): ?><link type="text/css" rel="stylesheet" href="<?php __pc('css_user', 'src')?>" /><?php ENDIF; ?>
